...
import com.fuser.config.ParserConfig;
...
public class ParserTest {
    ...
    public void justAnAtom() {
        ...
        assertParsing("Negative number", "[-1]:NUMBER", "-1");
        assertParsing("Positive number", "[+1]:NUMBER", "+1");
    ...
    public void simpleExpression() {
        ...
        assertParsing("", "([!=]:OPERATOR [1]:NUMBER [2]:NUMBER)", "1 != 2");
        assertParsing("", "([*]:ARITHMETIC [+1]:NUMBER [-2]:NUMBER)", "+1 * -2");
    }
    ...
    public void functions() {
        ...
        assertParsing("([CAST]:FUNCTION ([as]:ALIAS-CAST [campo2]:IDENTIFIER [VARCHAR]:IDENTIFIER))", "CAST(campo2 as VARCHAR)");
    }
